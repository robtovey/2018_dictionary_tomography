...
@cuda.jit('void(f4[:],f4[:],i4[:])', cache=True)
...
@cuda.jit('void(c8[:],c8[:],i4[:])', cache=True)
...
@cuda.jit('void(f4[:,:],f4[:,:],f4[:,:],i4[:])', cache=True)
...
@cuda.jit('void(c8[:,:],c8[:,:],c8[:,:],i4[:])', cache=True)
...
@cuda.jit('void(c8[:,:],f4[:],i4[:])', cache=True)
